...
public class GameManager : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        player1name = PlayerNameSetter.FindObjectOfType<PlayerNameSetter>().getPlayer1name();
        player2name = PlayerNameSetter.FindObjectOfType<PlayerNameSetter>().getPlayer2name();
        SetPlayerName();
